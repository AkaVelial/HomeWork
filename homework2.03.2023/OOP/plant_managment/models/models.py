from OOP.plant_managment.framework.models import*
...
class Plant(Model):
    ...
    def get_el_by_id(cls, id):
        try:
            ...
            print(f"An error occurred while getting plant by id: {e}")
...
class Salon(Model):
    ...
    def get_el_by_id(cls, id):
        try:
            ...
            print(f"An error occurred while getting salon by id: {e}")
...
class Employee(Model):
    ...
    def get_el_by_id(cls, id):
        try:
            ...
            print(f"An error occurred while getting employee by id {e}")

    def update(self):   #переробив так,бо при апдейті через абстрактний work_id повертає str замість int
        try:
            ...
            print(f"Error occurred while upating employee: {e}")
    ...
    def get_employee_workplace(cls, id):
        try:
            ...
            print(f"An error occurred while getting employee workplace {e}")